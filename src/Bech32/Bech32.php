...
/**
 * Class Bech32
 * @package FurqanSiddiqui\Binance\Bech32
 */
class Bech32
{
     ...
     * @return int
     */
    public static function polyMod(array $values, int $numValues)
    {
        $chk = 1;
     ...
     * @return int[]
     */
    public static function hrpExpand(string $hrp, int $hrpLen)
    {
        $expand1 = [];
        $expand2 = [];
        for ($i = 0; $i < $hrpLen; $i++) {
     ...
     * @throws Bech32Exception
     */
    public static function convertBits(array $data, int $inLen, int $fromBits, int $toBits, bool $pad = true)
    {
        $acc = 0;
        $bits = 0;
        $ret = [];
     ...
     * @return int[]
     */
    public static function createChecksum(string $hrp, array $convertedDataChars)
    {
     ...
     * @return bool
     */
    public static function verifyChecksum(string $hrp, array $convertedDataChars)
    {
     ...
     * @return string
     */
    public static function encode(string $hrp, array $combinedDataChars)
    {
     ...
     * @throws Bech32Exception
     */
    public static function decodeRaw(string $sBech)
    {
        $length = strlen($sBech);
        if ($length < 8) {
     ...
     * @throws Bech32Exception
     */
    public static function decode(string $sBech)
    {
        $length = strlen($sBech);
        if ($length > 90) {
     ...
     * @throws Bech32Exception
     */
    public static function validateWitnessProgram(int $version, string $program)
    {
     ...
     * @throws Bech32Exception
     */
    public static function encodeSegwit(string $hrp, int $version, string $program)
    {
        $version = (int)$version;
     ...
     * @throws Bech32Exception
     */
    public static function decodeSegwit(string $hrp, string $bech32)
    {
